...
public enum Status {
    ...
    UPLOAD_FILE_IN_PARALLEL_ERROR(1300110, "upload file in parallel exception", "多线程上传文件错误"),

    MERGE_FILE_ERROR(1300120, "merge file exception", "合并文件错误"),
    CURRENT_DIR_EMPTY_ERROR(1300130, "current dir empty error", "current dir 缺失"),
    UPLOAD_FILE_IN_PARALLEL_SESSION_ID_EMPTY_ERROR(1300140, "upload file in parallel sessionID is empty", "多线程上传，sessionID 为空"),
